  ...
  return (
    ...
    <>  
              ...
              <div className="invalid-feedback">{errors.dob}</div>
                ...
                <div className="col-md-3">
                  <label htmlFor="nameofkarta" className="form-label">Name of Karta</label>
                  <input
                    type="nameofkarta"
                    className="form-control"
                    id="nameofkarta"
                    name="nameofkarta"
                    value={formData.nameofkarta}
                    onChange={handleChange}
                    required
                  />
                </div>
                <div className="col-md-3">
                  <label htmlFor="aadharofkarta" className="form-label">Aadhar of Karta</label>
                  <input
                    type="text"
                    className="form-control"
                    id="aadharofkarta"
                    name="aadharofkarta"
                    value={formData.aadharofkarta}
                    onChange={handleChange}
                    required
                  />
                </div>
